            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div class="flex justify-between items-center mt-2">
                    <div class="flex items-center gap-3">
                        <input id="checkboxDefault1" class="w-5 h-5 rounded-md border-gray-300 text-[#3B82F6] focus:ring-[#3B82F6]" type="checkbox" value="">
                        <label for="checkboxDefault1" class="text-gray-600 font-medium cursor-pointer">Remember me</label>
                    </div>
                    <a href="{{ route('password.request') }}" class="text-[#3B82F6] hover:underline">
                ...
                <div class="text-center mt-8">
                    <p class="text-gray-600 text-lg">
                        ...
                        <a href="{{ route('register') }}" class="font-semibold text-[#3B82F6] hover:text-[#2563EB] transition-colors">
                            Sign Up
                        </a>
                    </p>
