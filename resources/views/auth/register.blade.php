    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div class="w-full max-w-md glass-effect p-10 rounded-2xl animate__animated animate__fadeIn">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <div class="relative">
                        <input
                            ...
                            id="name"
                            name="name"
                            class="input-field w-full px-5 py-4 border border-gray-200 rounded-xl focus:outline-none focus:border-[#9181FA] bg-gray-50"
                ...
                <button
                    type="submit"
                    class="btn-gradient w-full text-white py-4 px-6 rounded-xl text-lg font-semibold"
                >
                    Sign Up
                </button>
